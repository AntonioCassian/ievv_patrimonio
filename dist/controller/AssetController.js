...
export class AssetController {
    ...
    create = async (req, res) => {
        try {
            ...
            const asset = await this.assetService.create(req.body, user.id, req.file);
            ...
            if (error instanceof Error) {
                ...
                if (error.message ===
                    ...
                    return res.status(409).json({
                        success: false,
                        message: "Conflito ao gerar o código patrimonial.",
                    });
                }
            }
    ...
    findAll = async (req, res) => {
        try {
            const assets = await this.assetService.findAll(req.query);
    ...
    delete = async (req, res) => {
        try {
            await this.assetService.delete(req.params.id);
