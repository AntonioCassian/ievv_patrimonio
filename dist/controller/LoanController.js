...
export class LoanController {
    ...
    create = async (req, res) => {
        try {
            ...
            const loan = await this.loanService.create(req.body, user.id);
                ...
                switch (error.message) {
                    ...
                    case "ASSET_NOT_AVAILABLE":
                        return res
                            ...
                            .json({
                            success: false,
                            message: "O patrimônio não está disponível para empréstimo.",
                        });
                    ...
                    case "CREATOR_NOT_FOUND":
                        return res
                            ...
                            .json({
                            success: false,
                            message: "Usuário responsável pelo cadastro não encontrado.",
                        });
                }
            }
                ...
                switch (error.message) {
                    ...
                    case "LOAN_NOT_ACTIVE":
                        return res
                            ...
                            .json({
                            success: false,
                            message: "Somente empréstimos ativos podem ser alterados.",
                        });
                    case "RESPONSIBLE_NOT_FOUND":
                        return res
                            .status(404)
            ...
            if (error instanceof Error) {
                ...
                if (error.message ===
                    ...
                    return res
                        ...
                        .json({
                        success: false,
                        message: "Empréstimos ativos não podem ser excluídos.",
                    });
                }
            }
            return res.status(500).json({
                ...
                switch (error.message) {
                    ...
                    case "ASSET_NOT_IN_USE":
                        return res
                            ...
                            .json({
                            success: false,
                            message: "O patrimônio não está marcado como emprestado.",
                        });
                }
            }
            return res.status(500).json({
