...
export const createAssetSchema = z
    ...
    name: z
        .string()
        .trim()
        .min(1, "O nome do patrimônio é obrigatório")
        .max(150, "O nome do patrimônio deve ter no máximo 150 caracteres"),
    description: z
        .string()
        .trim()
    ...
    type: z
        .string()
        .trim()
        .min(1, "O tipo do patrimônio é obrigatório"),
    responsibleId: z
        .string()
        .min(1)
        .optional(),
    ...
    imageUrl: z
        .string()
        .url("A imagem deve possuir uma URL válida")
        .optional(),
})
    .refine((data) => {
    ...
    return (new Date(data.acquisitionDate) <=
        new Date());
}, {
