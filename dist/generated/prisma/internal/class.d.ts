 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
    ...
    /**
     * `prisma.assetOperation`: Exposes CRUD operations for the **AssetOperation** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more AssetOperations
      * const assetOperations = await prisma.assetOperation.findMany()
      * ```
      */
    get assetOperation(): Prisma.AssetOperationDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.usufructHistory`: Exposes CRUD operations for the **UsufructHistory** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more UsufructHistories
      * const usufructHistories = await prisma.usufructHistory.findMany()
      * ```
      */
    get usufructHistory(): Prisma.UsufructHistoryDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
}
