...
export class DashboardService {
    ...
    async getDashboard(
        ...
        const statusChart = assetsByStatus.map(
            (item) => ({
                status: item.status,
        ...
        const categoryChart = assetsByCategory.map(
            (item) => ({
        ...
        const operationChart = operationsByType.map(
            (item) => ({
                type: item.type,
                total: item._count._all,
            })
